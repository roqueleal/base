...
-title: "Víctimas del accionar represivo ilegal"
-author: "Roque Leal"
-vizjson: "http://vargasgarcia.carto.com/u/vargasgarcia/api/v2/viz/107c2be6-d55a-4eb5-a4bd-8dce89cb6eff/viz.json"
-duration: 18
```
...
El Registro Unificado de Victimas del Terrorismo de Estado [RUVTE](http://datos.jus.gob.ar/dataset/registro-unificado-de-victimas-del-terrorismo-de-estado-ruvte/archivo/c6b674bc-e178-41f3-81f5-0f10038e1688) estima hasta el último trimestre del 2018 un total de 9.537 víctimas del accionar represivo ilegal.
...
- center: [-33.5780, -62.4902]
- zoom: 5
```

Igualmente, otros casos que deben haber efectivamente ocurrido son estimados en 30.000 Víctimas por los movimientos de Derechos Humanos, que de hecho se continúan investigando. 
...
Los inicios de la década de 1970, las Fuerzas Armadas Argentinas comenzaron a desarrollar operativos ilegales de secuestro-tortura-desaparición en todo el territorio argentino en especial en las grandes ciudades. 


# Buenos Aires
```
- center: [-34.599, -58.464]
- zoom: 9
S.torqueLayer.actions.pause()
S.torqueLayer.actions.play()
- step: 112
...
```
- step: 198
- center: [-39.8085, -63.7207]
- zoom: 4
```
Desde 1983, comenzó el proceso de regreso de la democracia y con ello la restauración de un Estado de Derecho en la Argentina. 

![Represion](https://www.elintransigente.com/u/fotografias/m/2016/3/24/f800x450-338812_390258_0.jpg)
